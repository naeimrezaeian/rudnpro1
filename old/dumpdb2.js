...
// Name,Birthday,Sex ,Email ,Phone ,Address ,Country ,City ,FacultyId ,DepartmentId ,FieldId,TypeStudy ,FormStudy ,YearStudy ,Additional ,Photo ,Access,Status

user_list.push(new Model.User("962c20a8-682c-4c46-b1a5-4e26556f223f","Наим Резаиан",moment("2000-04-21","YYYY/MM/DD").toDate(),0,"rezaian-n@rudn.ru","+79252706166","Проспект мира дом 70","Россия","Москва",8,0,0,0,0,2019,"desc1","file","admin",1,hash));
 user_list.push(new Model.User("8dee61e1-73f2-a-9e8e-e682f8529baa","Ситников Клемент Авксентьевич",moment("2000-04-21","YYYY/MM/DD").toDate(),0,"admin@rudn.ru","+79211679562","ул. Славы, 37","Россия","Дмитров",8,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("fe7fbe6b-1701-47e7-b23d-a4a9fefbf225","Некрасов Мартин Ростиславович",moment("2000-04-22","YYYY/MM/DD").toDate(),0,"user3@rudn.ru","+79211679163","бульвар Славы, 80","Россия","Щёлково",8,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("5372fcef-168c-435f-bdb4-7d06333930d9","Шарапов Ким Мартынович",moment("2002-05-17","YYYY/MM/DD").toDate(),0,"user4@rudn.ru","+79223689512","пл. Сталина, 44","Россия","Москва",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("e39ee458-0ac9-48b3-9f13-b1d3702524cc","Потапов Лука Пантелеймонович",moment("1999-1-05","YYYY/MM/DD").toDate(),0,"user5@rudn.ru","+79273119212","пр. Ломоносова, 39","Россия","Видное",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("d49af1de-04df-4839-814b-96c0494e5277","Кабанов Иван Аркадьевич",moment("2001-06-06","YYYY/MM/DD").toDate(),0,"user6@rudn.ru","+79274118218","ул. Бухарестская, 46","Россия","Дорохово",2,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("3518492b-d529-489e-8fd3-17b0ef0108ae","Тетерин Лавр Мэлсович",moment("2000-03-12","YYYY/MM/DD").toDate(),0,"user7@rudn.ru","+79273119212","пр. Славы, 81","Одинцово","Россия",2,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("3e1ad7ca-38c1-4440-92c9-6d3841135c0f","Зимин Болеслав Кириллович",moment("2001-08-12","YYYY/MM/DD").toDate(),0,"user8@rudn.ru","+79573118277","спуск Сталина, 56","Россия","Шаховская",2,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("faf92dbf-e7c3-4dc0-9f6c-d2847343dd1c","Беляев Митрофан Ефимович",moment("1999-02-07","YYYY/MM/DD").toDate(),0,"user9@rudn.ru","+79118969513","шоссе Славы, 28","Россия","Москва",2,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("b7bf08b7-87a5-4dfd-b240-1ad9710f3dfd","Ермаков Вениамин Лукьевич",moment("2002-11-13","YYYY/MM/DD").toDate(),0,"user10@rudn.ru","+79224115217","ул. Домодедовская, 07","Россия","Балашиха",3,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("0a1d1bda-c674-4a2b-b6d6-82022c3779b8","Субботин Владлен Семёнович",moment("2000-01-14","YYYY/MM/DD").toDate(),0,"user11@rudn.ru","+79275119511","Бухарестская, 46","Россия","Москва",3,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("1c6c3221-c63c-466e-a6f6-266cef7b6785","Туров Марк Владимирович",moment("2000-09-02","YYYY/MM/DD").toDate(),0,"user12@rudn.ru","+79177079112","шоссе Ладыгина, 12","Россия","Истра",3,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("1d4340db-6df8-4b37-93f7-ab3f6d1b18b1","Трофимов Назарий Наумович",moment("2000-11-02","YYYY/MM/DD").toDate(),0,"user13@rudn.ru","+79273783219","проезд Ладыгина, 85","Россия","Красногорск",4,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("0ec6aab1-1781-467a-b9c6-7a4bb3fae29b","Щукин Яков Авдеевич",moment("2000-05-03","YYYY/MM/DD").toDate(),0,"user14@rudn.ru","+79273119212","пл. 1905 года, 25","Россия","Волоколамск",4,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("50a95fc4-1c49-4bc5-b16b-d6353c0eed02","Дроздов Адольф Оскарович",moment("2000-05-04","YYYY/MM/DD").toDate(),0,"user15@rudn.ru","+79274557781","спуск Домодедовская, 25","Россия","Ногинск",4,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("d449a796-abec-4758-b255-fbd3a5eb2b5b","Одинцов Аверьян Матвеевич",moment("2002-04-19","YYYY/MM/DD").toDate(),0,"user16@rudn.ru","+79273119212","пер. Чехова, 65","Россия","Серебряные Пруды",5,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("6ff8de02-71ef-4481-bda0-3e9caa3f9c2f","Воронов Тихон Протасьевич",moment("2001-11-18","YYYY/MM/DD").toDate(),0,"user17@rudn.ru","+79227788310","ул. Гагарина, 02","Россия","Москва",5,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("146822f4-beb2-4f9c-b9e6-3c3151ded7aa","Калинин Прохор Павлович",moment("1999-11-12","YYYY/MM/DD").toDate(),0,"user18@rudn.ru","+79227788311","спуск Будапештсткая, 86","Россия","Москва",5,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("a567f8e9-725c-41e1-9007-027207678db7","Дроздов Азарий Авдеевич",moment("2001-04-02","YYYY/MM/DD").toDate(),0,"user19@rudn.ru","+79228338310","пр. Космонавтов, 49","Россия","Москва",6,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("efbe3cc4-50f8-4a72-b6e4-fafb7a5f0259","Никонов Корнелий Николаевич",moment("2001-07-03","YYYY/MM/DD").toDate(),0,"user20@rudn.ru","+7981788315","наб. Гагарина, 60","Россия","Павловский Посад",6,0,0,0,0,2019,"desc1","file","student",1,hash));
 
 
 user_list.push(new Model.User("f75dd1d5-6a75-49b8-8708-237f403b5ed7","Абрамова Дебора Митрофановна",moment("2001-11-01","YYYY/MM/DD").toDate(),1,"user21@rudn.ru","+79211679562","пр. Балканская, 12","Россия","Москва",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("2ed944e7-374b-4075-a4bd-ccb85f171e4a","Юдина Серафима Валерьяновна",moment("2000-03-22","YYYY/MM/DD").toDate(),1,"user22@rudn.ru","+79211629674","пр. Балканская, 13","Россия","Москва",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("df829684-fe71-464c-b382-5d6c9ae3900c","Фёдорова Кристина Петровна",moment("2001-02-12","YYYY/MM/DD").toDate(),1,"user23@rudn.ru","+79221629675","пр. Балканская, 14","Россия","Москва",2,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("b316858c-28ef-4dc8-ad0a-876f009249a9","Данилова Розалина Германновна",moment("2000-08-12","YYYY/MM/DD").toDate(),1,"user24@rudn.ru","+79218629676","спуск Косиора, 90","Россия","Можайск",2,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("1792ea28-7529-44a0-a563-6a1c16cd9059","Королёва Северина Германновна",moment("2001-08-07","YYYY/MM/DD").toDate(),1,"user25@rudn.ru","+79251629671","ул. Ладыгина, 44","Россия","Дорохово",3,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("254186da-1857-43da-893b-8a003d0d2fb5","Лапина Элеонора Геласьевна",moment("2001-11-03","YYYY/MM/DD").toDate(),1,"user26@rudn.ru","+79222679563","бульвар Косиора, 81","Россия","Москва",3,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("cc23c6af-c6f0-4e7a-b6e6-2a58d43cbb83","Игнатова Серафима Натановна",moment("2000-09-04","YYYY/MM/DD").toDate(),1,"user27@rudn.ru","+79522679563","проезд Ленина, 27","Россия","Озёры",4,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("157bf93e-c62e-4ab1-b99b-8cfbe8442763","Сергеева Варвара Викторовна",moment("2001-12-02","YYYY/MM/DD").toDate(),1,"user28@rudn.ru","+79231679568","шоссе Славы, 91","Россия","Солнечногорск",4,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("33fbf79f-c3f3-4239-9ce5-307e32e18b1e","Сафонова Романа Станиславовна",moment("2001-05-02","YYYY/MM/DD").toDate(),1,"user29@rudn.ru","+79243679561","Космонавтов, 67","Россия","Москва",5,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("a6462eea-b8d1-473b-818b-818b0c7d9764","Никифорова Карина Васильевна",moment("2000-09-23","YYYY/MM/DD").toDate(),1,"user30@rudn.ru","+792743677571","шоссе Гагарина, 17","Россия","Москва",5,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("2f40af54-e320-4e27-a267-6e70a6960667","Кондратьева Риана Николаевна",moment("2001-02-14","YYYY/MM/DD").toDate(),1,"user31@rudn.ru","+79253119221","пр. Косиора, 26","Россия","Сергиев Посад",6,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("61405e07-a56d-4bbd-abde-a3662d079273","Лебедева Сусанна Геннадьевна",moment("2000-03-12","YYYY/MM/DD").toDate(),1,"user32@rudn.ru","+79213619161","въезд Славы, 156","Россия","Москва",6,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("1595f1f8-29cc-4858-8488-8093fe1f9fd0","Носова Милена Германновна",moment("2001-04-27","YYYY/MM/DD").toDate(),1,"user33@rudn.ru","+79253666561","пр. Космонавтов, 71","Россия","Солнечногорск",7,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("50088ff6-be61-42ca-be02-7790e5d53d73","Тимофеева Лина Руслановна",moment("2001-02-28","YYYY/MM/DD").toDate(),1,"user34@rudn.ru","+79243679567","проезд Бухарестская, 16","Россия","Сергиев Посад",7,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("c0a7934d-bfbc-40ff-bb2f-4fdec014ad8c","Николаева Элла Анатольевна",moment("2002-07-28","YYYY/MM/DD").toDate(),1,"user35@rudn.ru","+79763679577","наб. Ленина, 36","Россия","Москва",8,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("ec674ab6-13cc-4519-b76f-792e3cea374a","Третьякова Фелиция Наумовна",moment("2002-8-02","YYYY/MM/DD").toDate(),1,"user36@rudn.ru","+79211679665","ул. Маяковского, дом 18","Россия","Москва",8,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("45cbfcf8-8efd-421c-80f6-082aefd05a73","Елисеева Валерия Евсеевна",moment("2001-11-11","YYYY/MM/DD").toDate(),1,"user37@rudn.ru","+79222679664","ул. Пушкина, дом 3","Россия","Москва",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("24f84793-5e7f-48df-8352-dcc8f5d15804","Миронова Рая Антониновна",moment("2001-02-01","YYYY/MM/DD").toDate(),1,"user38@rudn.ru","+792886796633","ул. Сталина, дом 60","Россия","г.Воротынец",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("6d8afd67-c736-433b-8b94-75ac946c11fd","Логинова Ирина Святославовна",moment("2001-08-07","YYYY/MM/DD").toDate(),1,"user39@rudn.ru","+79201679615","ул. Садовая, дом 33","Россия","г.Борисоглебск",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 user_list.push(new Model.User("93030715-f71b-479e-958a-3019156c030c","Гущина Дионисия Дмитрьевна",moment("2002-06-13","YYYY/MM/DD").toDate(),1,"user40@rudn.ru","+79212679110","ул. Хрущёва, дом 64","Россия","г.Дрожжаное",1,0,0,0,0,2019,"desc1","file","student",1,hash));
 
 user_list.push(new Model.User("83b71e05-f414-4c83-9774-7d0aeb44fedd","Селезнёв Панкратий Витальевич",moment("1986-06-13","YYYY/MM/DD").toDate(),1,"user41@rudn.ru","+79212679111","ул. Хрущёва, дом 65","Россия","Москва",8,0,0,0,0,2019,"desc1","file","teacher",1,hash));
 user_list.push(new Model.User("108e5270-91ee-471b-adfc-b874992794b1","Потапов Пантелей Тимурович",moment("1981-11-02","YYYY/MM/DD").toDate(),1,"user42@rudn.ru","+79212679112","ул. Хрущёва, дом 66","Россия","Москва",3,0,0,0,0,2019,"desc1","file","teacher",1,hash));
 user_list.push(new Model.User("6ebd5269-1f59-4cfe-bdef-53c90e8cf1d7","Ширяев Юстин Игнатьевич",moment("1981-12-12","YYYY/MM/DD").toDate(),1,"user43@rudn.ru","+79212679113","ул. Хрущёва, дом 67","Россия","Москва",3,0,0,0,0,2019,"desc1","file","teacher",1,hash));
 user_list.push(new Model.User("2acdb9a0-2354-43fa-9bc5-a05669d9f000","Меркушев Аскольд Игоревич",moment("1982-09-07","YYYY/MM/DD").toDate(),1,"user44@rudn.ru","+79212679114","ул. Хрущёва, дом 68","Россия","Москва",3,0,0,0,0,2019,"desc1","file","teacher",1,hash));
...
//Model
//Title,FacultyId,DepartmentId,FieldId,SubjectId,UrlModel,Parameters,Description,GeneralModel,Status
var model = [];
model.push(new Model.Model("ИИ модель 1",1,1,1,1,"http://37.18.79.144/ai/api/","1","Описание 1",0,1));
model.push(new Model.Model("ИИ модель 2",3,11,7,3,"http://37.18.79.144/ai/api/","2","Описание 2",1,1));
model.push(new Model.Model("ИИ модель 3",3,11,7,4,"http://37.18.79.144/ai/api/","3","Описание 3",0,1));
model.push(new Model.Model("ИИ модель 4",3,12,8,5,"http://37.18.79.144/ai/api/","4","Описание 4",1,1));
...
//Group
//Title,YearStudy,fieldId,TypeStudy,Description,Students,Status
var group = [];

group.push( new Model.Group("НИБ-201","2019-2020",1,"Описание 1",1,1));
group.push( new Model.Group("НИБ-202","2019-2020",1,"Описание 2",1,3));
group.push( new Model.Group("НИБ-203","2019-2020",1,"Описание 3",1,3));
group.push( new Model.Group("НИБ-204","2020-2021",0,"Описание 4",1,3));
group.push( new Model.Group("НИБ-205","2020-20212021",0,"Описание 5",1,2));
group.push( new Model.Group("НИБ-206","2020-20212021",1,"Описание 6",1,10));
group.push( new Model.Group("НИБ-207","2020-20212021",1,"Описание 7",1,3));
group.push( new Model.Group("НИБ-208","2019-2020",15,"Описание 8",1,10));
group.push( new Model.Group("НИБ-209","2019-2020",1,"Описание 9",1,2));
group.push( new Model.Group("НИБ-2010","2019-2020",1,"Описание 10",1,1));

//GroupStudents
//GroupId,StudentId,Status
var groupstudent = [];
groupstudent.push( new Model.GroupStudent(1,'0a1d1bda-c674-4a2b-b6d6-82022c3779b8'));
groupstudent.push( new Model.GroupStudent(1,'146822f4-beb2-4f9c-b9e6-3c3151ded7aa'));
groupstudent.push( new Model.GroupStudent(1,'3518492b-d529-489e-8fd3-17b0ef0108ae'));
groupstudent.push( new Model.GroupStudent(1,'6d8afd67-c736-433b-8b94-75ac946c11fd'));

groupstudent.push( new Model.GroupStudent(2,'0ec6aab1-1781-467a-b9c6-7a4bb3fae29b'));
groupstudent.push( new Model.GroupStudent(2,'24f84793-5e7f-48df-8352-dcc8f5d15804'));
groupstudent.push( new Model.GroupStudent(2,'2f40af54-e320-4e27-a267-6e70a6960667'));
groupstudent.push( new Model.GroupStudent(2,'a6462eea-b8d1-473b-818b-818b0c7d9764'));

groupstudent.push( new Model.GroupStudent(3,'2ed944e7-374b-4075-a4bd-ccb85f171e4a'));
groupstudent.push( new Model.GroupStudent(3,'50a95fc4-1c49-4bc5-b16b-d6353c0eed02'));
groupstudent.push( new Model.GroupStudent(3,'6ff8de02-71ef-4481-bda0-3e9caa3f9c2f'));
groupstudent.push( new Model.GroupStudent(3,'d449a796-abec-4758-b255-fbd3a5eb2b5b'));
groupstudent.push( new Model.GroupStudent(3,'ec674ab6-13cc-4519-b76f-792e3cea374a'));
...
//Question
//TeacherId,SubjectId,QuestionContent,AnswerContent,QuestionType,Model,Status
var question = [];
question.push(new Model.Question(1,2,"Q1","A1",1,1,1));
question.push(new Model.Question(1,2,"Q2","A2",1,1,1));
question.push(new Model.Question(1,2,"Q2","A2",1,1,1));
question.push(new Model.Question(1,2,"Q3","A3",1,1,1));
question.push(new Model.Question(41,2,"Q1","A1",1,1,1));
question.push(new Model.Question(41,2,"Q2","A2",1,1,1));
...
var subgroupstudent = [];
subgroupstudent.push(new Model.SubGroupStudent(1,2,1));
subgroupstudent.push(new Model.SubGroupStudent(1,3,1));
subgroupstudent.push(new Model.SubGroupStudent(1,4,1));
subgroupstudent.push(new Model.SubGroupStudent(1,5,1));
subgroupstudent.push(new Model.SubGroupStudent(2,20,1));
subgroupstudent.push(new Model.SubGroupStudent(2,21,1));
subgroupstudent.push(new Model.SubGroupStudent(2,22,1));
